...
public class Select {
    public static TrackMertics lastRunMetrics;

    public static int deterministicSelect(int[] arr, int k) {
        TrackMertics metrics = new TrackMertics();
    ...
    private static int medianOfMedians(int[] arr, TrackMertics metrics) {
    ...
    private static int deterministicSelectHelper(int[] arr, int k, int left, int right, TrackMertics metrics) {
        metrics.increaseRecursionDepth();
    ...
    private static int partition(int[] arr, int left, int right, int pivot, TrackMertics metrics) {
    ...
    private static int findPivotIndex(int[] arr, int left, int right, int pivot, TrackMertics metrics) {
