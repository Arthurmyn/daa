...
public class QuickSort {
    ...
    private static void quickSortLoop(int[] arr, int low, int high, TrackMertics metrics) {
    ...
    private static int partition(int[] arr, int low, int high, TrackMertics metrics) {
    ...
    private static void swap(int[] arr, int i, int j, TrackMertics metrics) {
        int temp = arr[i];
        arr[i] = arr[j];
        arr[j] = temp;
    }
