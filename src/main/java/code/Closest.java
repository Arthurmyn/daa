...
public class Closest {
    public static double findClosestPair(Point[] points, TrackMertics metrics) {
    ...
    private static double findRecursive(Point[] pointsByX, Point[] pointsByY, TrackMertics metrics) {
    ...
    private static double bruteForce(Point[] points, TrackMertics metrics) {
